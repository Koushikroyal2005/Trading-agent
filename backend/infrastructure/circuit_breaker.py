...
class CircuitBreaker:
    def __init__(self,failure_threshold:int=3,recovery_seconds:float=30): self.failures=0;self.threshold=failure_threshold;self.recovery_seconds=recovery_seconds;self.opened_at:float|None=None
    @property
